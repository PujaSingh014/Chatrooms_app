...
class Coding extends StatefulWidget {
  String uname;
  Coding({required this.uname});
  @override
  _CodingState createState() => _CodingState(uname: uname);
}

class _CodingState extends State<Coding> {
  String uname;
  _CodingState({required this.uname});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: modified_text(size: 25 ,text: 'Coding' ),
